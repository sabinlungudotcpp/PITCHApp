const GUIDELINE_DATA = [ // Array of JSON objects to store the guideline data
    {
        ...
        "good_practice_descriptions": [ // Descriptions for good practice
            ...
            {
                "description_id": 1005,
                "description_practice": "5. Building balanced relationships based on mutual trust with empowers children to share in the decision-making process",
                "canBeModified": false
            },
            ...
            {
                "description_id": 1007,
                "description_practice": "7. Ensuring that if any form of manual/physical support is required, it should be provided openly and according to guidelines provided by the Coach Education Programme. Care is needed, as it is difficult to maintain hand positions when the child is constantly moving. Young people and their parents should always be conslted and their agreement gained",
                "canBeModified": false
            },
            ...
            {
                "description_id": 1018,
                "description_practice": "Requesting writing parental consent if officials are required to transport young people in their cars."
            }
        ],
...

    {
        ...
        "practice_avoid_descriptions": [
            ...
            {
                "description_id": 1020,
                "descripton_avoid": "2. Avoid taking or dropping off a child to an event or activity"
            }
        ],
